/**
 * ARCHIVED: MemStorage class - No longer used by the application
 * This file is kept for reference only and contains the previous in-memory storage implementation.
 * The application now exclusively uses DatabaseStorage and requires DATABASE_URL to be configured.
 */

import { type User, type InsertUser, type Product, type InsertProduct, type Category, type InsertCategory, type AboutSection, type InsertAboutSection } from "@shared/schema";
